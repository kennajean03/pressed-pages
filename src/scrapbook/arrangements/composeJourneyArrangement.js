import layoutSingleHero from "./singleHero"
import layoutPhotoFan from "./photoFan"
import layoutHeroMoment from "./heroMoment"
import layoutMixedCluster from "./mixedCluster"
import layoutFullSpread from "./fullSpread"

import composeBookJourneyStory from "../composers/composeJourneyAnalysis"
...
export function composeJourneyArrangement({
  photos = [],
  quotes = [],
  flowers = [],
} = {}) {
...
export default composeJourneyArrangement